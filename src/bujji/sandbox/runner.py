...
_OUTPUT_START = "---BUJJI_OUTPUT_START---"
_OUTPUT_END = "---BUJJI_OUTPUT_END---"
...
class ContainerRunner:
    ...
    ----------
    image:
        Docker image to run.  Defaults to ``bujji-sandbox:latest``.
    timeout:
    ...
    DEFAULT_IMAGE = "bujji-sandbox:latest"
    DEFAULT_TIMEOUT = 300
