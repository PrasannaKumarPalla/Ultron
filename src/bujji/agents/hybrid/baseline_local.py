"""BaselineLocalAgent â€” local-only reference for the hybrid ablation.
...
is involved â€” this is the "what does the local model do by itself?" floor
...
class BaselineLocalAgent(LocalCloudAgent):
    ...
    def _run_paradigm(
        ...
        **kwargs: Any,
        ...
        # GAIA branch â€” one-shot local call. Matches baseline_cloud's
