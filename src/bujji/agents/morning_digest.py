...
from bujji.agents.digest_store import DigestArtifact, DigestStore
...
def _load_persona(persona_name: str) -> str:
    ...
    search_paths = [
        Path("configs/bujji/prompts/personas") / f"{persona_name}.md",
...
class MorningDigestAgent(ToolUsingAgent):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self._persona = kwargs.pop("persona", "bujji")
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        evaluator_feedback = ""
        try:
            from bujji.agents.digest_evaluator import DigestEvaluator
