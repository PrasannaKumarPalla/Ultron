"""``bujji digest`` â€” display and play the morning digest."""
...
from bujji.agents.digest_store import DigestStore
...
def digest(
    ...
    if fresh:
        ...
        if has_audio:
            ...
            console.print("[yellow]Audio unavailable â€” TTS failed.[/yellow]")
