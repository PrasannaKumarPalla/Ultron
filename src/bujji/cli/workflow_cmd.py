"""``bujji workflow`` â€” workflow management commands."""
...
def list_workflows() -> None:
    ...
    try:
        from bujji.workflow.loader import discover_workflows
...
def run(workflow_name: str, input_text: str | None) -> None:
    ...
    try:
        ...
        # Full execution would need a BujjiSystem â€” just report for now
        console.print(
