"""``bujji connect`` -- manage data source connections."""
...
def _connect_source(registry: object, source: str, path: str = "") -> None:
    ...
    if auth_type == "filesystem":
        ...
        from bujji.connectors.oauth import save_tokens
...
def connect(
    ...
    import bujji.connectors  # noqa: F401 â€” registers all connectors
