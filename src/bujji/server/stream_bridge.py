...
from bujji.agents._stubs import AgentContext, BaseAgent
    ...
    async def stream(self) -> AsyncGenerator[str, None]:
        ...
        try:
            ...
            try:
                ...
                logger = logging.getLogger("bujji.server")
            ...
            if engine is not None and hasattr(engine, "stream_full") and content:
                ...
                try:
                    from bujji.core.types import Message as MsgType
                    from bujji.core.types import Role as RoleType
                    ...
                    _logger = _logging.getLogger("bujji.server")
                    _logger.warning(
