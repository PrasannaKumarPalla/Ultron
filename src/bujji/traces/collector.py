"""TraceCollector â€” wraps any BaseAgent to record interaction traces."""
...
def record_response_trace(
    ...
    *,
    ...
    this so those interactions still land in ``traces.db`` â€” otherwise streamed
    ...
    try:
        ...
        logging.getLogger("bujji.traces").debug(
