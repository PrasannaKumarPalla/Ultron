"""ToolTranslator â€” translate external tool names to Bujji equivalents.

External skill libraries (Hermes Agent, OpenClaw) reference tools by Claude
Code's standard tool names (Bash, Read, Write, etc.).  Bujji uses
...
# ---------------------------------------------------------------------------
# Translation table â€” external name â†’ Bujji name
# ---------------------------------------------------------------------------
