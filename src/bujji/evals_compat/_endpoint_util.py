...
Used by the first-party eval backends (bujji-direct, bujji-agent) when
...
def build_endpoint_engine(
    ...
    error when it is unreachable â€” engine discovery is never consulted.
    """
    ...
    if engine_key:
        logger.warning(
            ...
            "base_url wins â€” targeting the endpoint directly.",
            engine_key,
            base_url,
        )
