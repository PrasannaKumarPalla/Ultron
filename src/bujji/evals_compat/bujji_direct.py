"""Bujji Direct backend â€” engine-level inference for local and cloud models."""
...
from bujji.evals_compat._commit_util import bujji_commit
from bujji.evals_compat.backend import InferenceBackend


class BujjiDirectBackend(InferenceBackend):
    ...
    backend_id = "bujji-direct"
    framework_name = "bujji"
    ...
    def __init__(
        ...
        if base_url:
            ...
            from bujji.evals_compat._endpoint_util import (
    ...
    def framework_commit_value(self) -> str:
        """Bujji repo HEAD commit (for telemetry tagging)."""
        from bujji.evals_compat._commit_util import bujji_commit
    ...
    def generate_full(
        ...
        *,
        ...
        # Spec Â§6.2 extended fields for cross-framework comparison.
