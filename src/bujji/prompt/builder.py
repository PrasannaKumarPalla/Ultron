...
from bujji.core.config import MemoryFilesConfig, SystemPromptConfig
...
class SystemPromptBuilder:
    ...
    def _load_file(self, path_str: str, max_chars: int) -> str:
        ...
        # resolves to empty paths). Guard before Path("") â€” which becomes "." â€”
    ...
    def _resolve_persona(mf: MemoryFilesConfig) -> MemoryFilesConfig:
        ...
        - "<name>"    -> ~/.bujji/personas/<name>/{SOUL,MEMORY,USER}.md
        """
