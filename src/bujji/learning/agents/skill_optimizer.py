...
``~/.bujji/learning/skills/<skill-name>/optimized.toml``.
...
from bujji.core.types import Trace, TraceStep
from bujji.skills.manager import SkillManager
from bujji.skills.overlay import SkillOverlay, write_overlay
...
class SkillOptimizer:
    ...
    def _run_dspy(
        ...
        """
        from bujji.core.config import DSPyOptimizerConfig
        from bujji.learning.agents.dspy_optimizer import DSPyAgentOptimizer
    ...
    def _run_gepa(
        ...
        from bujji.learning.agents.gepa_optimizer import GEPAAgentOptimizer
