...
from bujji.mcp.protocol import MCPRequest, MCPResponse
...
class StdioTransport(MCPTransport):
    ...
    def send_notification(self, request: MCPRequest) -> None:
        """Send a JSON-RPC notification â€” write only, never read.
...
class StreamableHTTPTransport(MCPTransport):
    ...
    def _build_headers(self) -> dict:
        ...
        constructed with a token (#461) â€” required by authenticated MCP
