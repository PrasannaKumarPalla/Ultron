...
from bujji.mcp.protocol import MCPError, MCPRequest, MCPResponse
from bujji.mcp.transport import MCPTransport
...
class MCPClient:
    ...
    def initialize(self) -> Dict[str, Any]:
        ...
        params = {
            ...
            "capabilities": {},
            "clientInfo": {"name": "bujji", "version": "0.1.0"},
        }
    ...
    def list_tools(self) -> List[ToolSpec]:
        ...
        # ToolSpec timeout (30s) kills them mid-scan. Bump to 600s â€” individual
