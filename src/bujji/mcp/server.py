"""MCP Server â€” wraps Bujji tools as MCP-discoverable tools."""
...
from bujji.core.types import ToolCall
from bujji.mcp.protocol import (
    INTERNAL_ERROR,
    INVALID_PARAMS,
    METHOD_NOT_FOUND,
    MCPRequest,
...
class MCPServer:
    """MCP server that exposes Bujji tools via JSON-RPC.
    ...
    def _auto_discover_tools() -> List[BaseTool]:
        ...
        # Built-in API tools
        try:
            from bujji.tools.calculator import CalculatorTool
        ...
        try:
            ...
            pass
        try:
            from bujji.tools.file_read import FileReadTool
        ...
        try:
            ...
            pass
        try:
            from bujji.tools.code_interpreter import CodeInterpreterTool

            _tool_classes.append(CodeInterpreterTool)
        except ImportError:
            pass
        try:
            from bujji.tools.repl import ReplTool
        ...
        # Storage MCP tools
        try:
            from bujji.tools.storage_tools import (
                MemoryIndexTool,
                MemoryRetrieveTool,
                MemorySearchTool,
                MemoryStoreTool,
        ...
        # Channel MCP tools
        try:
            from bujji.tools.channel_tools import (
                ChannelListTool,
                ChannelSendTool,
                ChannelStatusTool,
            )
