...
Single source of truth for every event name and property the Bujji
...
also dropped. This is the fail-closed half of the PII guardrail â€”
see :mod:`bujji.analytics.redaction` for the value-level filters.
...
def _is_hash16(v: Any) -> bool:
    """sha256 prefix, 16 hex chars â€” used for hashed model/tool identifiers."""
...
_SPECS: tuple[EventSpec, ...] = (
    ...
    EventSpec(
        name="app_opened",
        description="App boot â€” every launch of CLI or desktop UI.",
        properties={
    ...
    EventSpec(
        ...
        description="`bujji init` finished and config.toml was written.",
        properties={
    ...
    EventSpec(
        ...
        description=(
            ...
            "Aggregated counts only â€” no content."
        ),
        properties={
