...
def create_energy_monitor(
    ...
    try:
        from bujji.telemetry.energy_nvidia import NvidiaEnergyMonitor
    ...
    try:
        from bujji.telemetry.energy_amd import AmdEnergyMonitor
    ...
    try:
        from bujji.telemetry.energy_apple import AppleEnergyMonitor
    ...
    try:
        from bujji.telemetry.energy_rapl import RaplEnergyMonitor
