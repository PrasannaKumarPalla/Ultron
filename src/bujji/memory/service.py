...
never blocks ``bujji serve`` request handling or the ``bujji chat`` REPL.
...
The service is started and stopped as part of the Bujji lifecycle (see
...
from bujji.core.events import Event, EventBus, EventType
from bujji.memory.extractor import FactExtractor
from bujji.memory.store import Fact, FactStore, create_fact_store
