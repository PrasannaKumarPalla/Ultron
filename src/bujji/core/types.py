"""Canonical data types shared across all Bujji primitives."""
...
# without crossing the server â†’ telemetry layering.
...
class TelemetryRecord:
    ...
    # metric â€” they were the dominant source of the bimodal Wh/token
