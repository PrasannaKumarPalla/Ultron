"""High-level Python SDK for Bujji."""
...
from bujji.system import BujjiSystem, SystemBuilder
...
class MemoryHandle:
    ...
    def __init__(self, config: BujjiConfig) -> None:
        self._config = config
    ...
    def _get_backend(self) -> Any:
        ...
        if not MemoryRegistry.contains(key):
            ...
            try:
                from bujji.tools.storage.sqlite import SQLiteMemory  # noqa: F401
            except ImportError:
                pass
    ...
    def index(
        ...
        *,
        ...
        from bujji.tools.storage.chunking import ChunkConfig
...
class Bujji:
    ...
    @property
    def config(self) -> BujjiConfig:
        """Return the active configuration."""
        return self._config

    @property
    def version(self) -> str:
        """Return the Bujji version string."""
        return bujji.__version__
    ...
    def _run_agent(
        ...
        *,
        ...
        if tools:
            ...
            from bujji.cli.ask import _build_tools
        ...
        if agent_name == "morning_digest" and hasattr(self._config, "digest"):
            ...
            from bujji.tools.text_to_speech import TextToSpeechTool
        ...
        if context and self._config.agent.context_from_memory:
            try:
                from bujji.cli.ask import _get_memory_backend
...
__all__ = ["Bujji", "BujjiSystem", "MemoryHandle", "SystemBuilder"]
