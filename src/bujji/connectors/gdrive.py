...
from bujji.connectors.google_auth import call_with_refresh
...
class GDriveConnector(BaseConnector):
    ...
    def handle_callback(self, code: str) -> None:
        ...
        The actual browser consent + codeâ†’token exchange is owned by the
        in-process server flow (``/v1/connectors/{id}/oauth/start`` â†’
        ...
        # completed credential â€” persist it and let the server flow finish auth.
