...
# Order doesn't matter â€” each entry is independent and idempotent.
...
class KnowledgeStore(MemoryBackend):
    ...
    def __init__(self, db_path: Union[str, Path] = "") -> None:
        ...
        if self._db_path != ":memory:":
            from bujji.security.file_utils import secure_create
    ...
    def distinct_sources(self) -> List[str]:
        ...
        sources the user actually has connected â€” so the model doesn't
