...
from bujji.connectors._stubs import Attachment, Document
from bujji.connectors.chunker import SemanticChunker
...
if TYPE_CHECKING:
    from bujji.connectors.attachment_store import AttachmentStore
...
class IngestionPipeline:
    ...
    def _embed_chunk(self, content: str) -> tuple[Optional[bytes], str]:
        ...
        fails â€” ingestion continues with the lexical-only row, so a flaky
