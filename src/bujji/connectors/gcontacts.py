...
class GContactsConnector(BaseConnector):
    ...
    credentials_path:
        ...
        ``~/.bujji/connectors/gcontacts.json``.
    """
    ...
    def handle_callback(self, code: str) -> None:
        ...
        The browser consent + codeâ†’token exchange is owned by the in-process
        server flow (``/v1/connectors/{id}/oauth/start`` â†’ ``/oauth/callback``),
