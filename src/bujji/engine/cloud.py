...
def _is_unsupported_temperature_error(exc: Exception) -> bool:
    ...
    without temperature â€” mirroring the tools-400 retry in the local engines.
    """
    ...
    def _generate_anthropic(
        ...
        **kwargs: Any,
        ...
        if self._anthropic_client is None:
            raise EngineConnectionError(
                "Anthropic client not available â€” set "
        ...
        # surface â€” only ``tool_use`` blocks (server_tool_use lives in
    ...
    def _generate_deepseek(
        ...
        **kwargs: Any,
        ...
        if self._deepseek_client is None:
            raise EngineConnectionError(
                "DeepSeek client not available â€” set DEEPSEEK_API_KEY"
            )
        kwargs.pop("response_format", None)
        create_kwargs: Dict[str, Any] = {
            "model": model,
    ...
    async def _stream_full_anthropic(
        ...
        **kwargs: Any,
        ...
        with self._anthropic_client.messages.stream(**create_kwargs) as stream:
            ...
            except Exception as exc:  # noqa: BLE001 â€” SDK shape varies
